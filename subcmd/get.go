...
func (cmd *getCmd) Run(runctx *RunContext) *Error {
	// Parse args
	...
	reposPathList, err := cmd.getReposPathList(args, runctx.LockJSON)
	if err != nil {
	...
	err = cmd.doGet(reposPathList, runctx.LockJSON, runctx.Config)
	if err != nil {
